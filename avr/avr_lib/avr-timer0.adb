...
package body AVR.Timer0 is
...
#if MCU = "attiny13" or else MCU = "atmega328p" or else MCU = "atmega168" then
   ...
   Overflow_Interrupt_Enable       : Boolean renames MCU.TIMSK_Bits (MCU.TOIE0_Bit);
#elsif MCU = "attiny13" or else MCU = "atmega168" or else MCU = "atmega169" or else MCU = "atmega328p" or else MCU = "atmega644" or else MCU = "atmega644p" then
